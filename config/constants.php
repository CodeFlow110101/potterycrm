...
return [
  ...
  'admin-booking-1-day-before-alert-message' => 'A customer has a booking tomorrow. Customer name: {full name}, No of people: {no of people}, Phone no: {phoneno}',
  'admin-booking-1-hour-before-alert-message' => 'A customer has a booking in an hour. Customer name: {full name}, No of people: {no of people}, Phone no: {phoneno}',
