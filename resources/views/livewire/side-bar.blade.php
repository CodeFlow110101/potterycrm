    ...
    <div class="h-min grid grid-cols-1 gap-10">
        ...
        <div class="h-min grid grid-cols-1 gap-8 pr-4">
            ...
            <div class="flex justify-start items-center gap-4">
                <div class="border-4 w-0 h-full rounded-br-3xl rounded-tr-3xl border-green-500"></div>
                <div class="flex justify-start items-center gap-4 w-full p-2 rounded-md hover:bg-white/40 transition-colors duration-300">
