...
<div class="h-full flex flex-col pb-8 pt-20">
    ...
    <div class="grow flex flex-col gap-10">
        <div class="h-min grid grid-cols-1 gap-8">
            ...
            <div class="flex justify-between items-center gap-4 pl-3">
                <div class="flex justify-center items-center w-full">
                    <a href="/purchase" wire:navigate class="flex justify-center items-center gap-4 w-min p-2 rounded-md group hover:bg-amber-500 transition-colors duration-300">
                        <svg class="w-8 h-8 text-amber-500 group-hover:text-white transition-colors duration-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="@if($path != 'purchase') invisible @endif border-2 rounded-full w-0 h-8 border-amber-500"></div>
            </div>
            <div class="flex justify-between items-center gap-4 pl-3">
                <div class="flex justify-center items-center w-full">
                    <a href="/order" wire:navigate class="flex justify-center items-center gap-4 w-min p-2 rounded-md group hover:bg-amber-500 transition-colors duration-300">
                        <svg class="w-8 h-8 text-amber-500 group-hover:text-white transition-colors duration-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                            <path fill-rule="evenodd" d="M4 4a2 2 0 0 0-2 2v9a1 1 0 0 0 1 1h.535a3.5 3.5 0 1 0 6.93 0h3.07a3.5 3.5 0 1 0 6.93 0H21a1 1 0 0 0 1-1v-4a.999.999 0 0 0-.106-.447l-2-4A1 1 0 0 0 19 6h-5a2 2 0 0 0-2-2H4Zm14.192 11.59.016.02a1.5 1.5 0 1 1-.016-.021Zm-10 0 .016.02a1.5 1.5 0 1 1-.016-.021Zm5.806-5.572v-2.02h4.396l1 2.02h-5.396Z" clip-rule="evenodd" />
                        </svg>
                    </a>
                </div>
                <div class="@if($path != 'order') invisible @endif border-2 rounded-full w-0 h-8 border-amber-500"></div>
            </div>
        </div>
