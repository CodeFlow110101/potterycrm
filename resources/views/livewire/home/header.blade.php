...
<div>
    <nav class="flex justify-between items-center mt-5 mx-auto uppercase font-avenir-next-bold text-white">
        ...
        <div x-data class="flex justify-evenly items-center w-full *:underline-offset-4">
            ...
            <div :class="$wire.routeName === $el.getAttribute('href') && 'underline'">Parties</div>
            <div :class="$wire.routeName === $el.getAttribute('href') && 'underline'">Private Groups</div>
            <div :class="$wire.routeName === $el.getAttribute('href') && 'underline'">Classes</div>
            @endif
            ...
            <div class="flex justify-between items-center relative group">
                <div class="relative group">
                    ...
                    <div class="absolute hidden group-hover:block inset-x-0 -mx-16 pt-2 font-avenir-next-regular text-black">
