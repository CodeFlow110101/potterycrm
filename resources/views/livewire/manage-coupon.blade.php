...
<div class="font-avenir-next-rounded-light flex flex-col grow">
    <div class="flex justify-end py-4">
        <button wire:click="toggleModal" class="bg-primary bg-opacity-90 hover:bg-opacity-100 text-white py-3 px-6 uppercase font-avenir-next-rounded-extra-light tracking-wider">Add Coupon</button>
    </div>
    ...
    @if($modal)
    <div class="fixed inset-0 flex justify-center items-center text-primary text-base">
        <div class="m-auto py-4 w-1/2 border shadow flex flex-col gap-2 bg-white">
            <div class="flex justify-end w-11/12 mx-auto">
                <button wire:click="toggleModal" class="outline-none rounded-full hover:bg-black/30 p-1 group">
                    <svg class="size-6 text-black/30 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <form wire:submit="submit" class="w-11/12 mx-auto py-4 flex flex-col gap-4">
                ...
                <div class="flex gap-8">
                    <div class="flex-1">
                        <label>Repeat Cycle in Days</label>
                ...
                <button class="bg-primary mx-auto bg-opacity-90 hover:bg-opacity-100 text-white py-3 px-6 w-min uppercase font-avenir-next-rounded-extra-light tracking-wider">Submit</button>
            </form>
        </div>
    </div>
    @endif
