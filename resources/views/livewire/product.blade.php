...
<div class="grow flex flex-col gap-8 py-8 text-white w-11/12 mx-auto">
    <div class="flex justify-between items-center">
        <div class="text-7xl font-avenir-next-bold">Product</div>
        <a href="shop" wire:navigate class="text-black py-3 uppercase px-6 bg-white rounded-lg tracking-tight flex gap-4">
            <div>
    ...
    <div class="grow flex backdrop-blur-xl p-6 border border-white rounded-lg gap-24">
